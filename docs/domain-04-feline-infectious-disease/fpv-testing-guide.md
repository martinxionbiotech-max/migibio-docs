...
**Does a negative rule out FPV?** No — intermittent shedding can yield a false negative; retest if suspicion is high.

## Case Study: The Cattery Outbreak

A 10-week-old kitten in a multi-cat household presents acutely with vomiting, profuse diarrhea, and lethargy. Two littermates died the previous week with similar signs.

- **FPV antigen (fecal): positive.**
- **Complete blood count**: severe leukopenia (WBC 0.8 × 10⁹/L).
- **SAA (feline serum amyloid A): markedly elevated** — consistent with systemic inflammation.

**Management:** Immediate isolation of the affected kitten, intensive intravenous fluid therapy, antiemetics, and broad-spectrum antibiotic cover for secondary bacterial translocation. The cattery initiated an outbreak protocol: quarantine of exposed cats and vaccination review.

**Lesson:** In a multi-cat setting, one confirmed FPV case is an outbreak signal. The same-visit antigen result triggered isolation and supportive care within the hour, while SAA provided an objective, monitorable inflammation marker during recovery.
