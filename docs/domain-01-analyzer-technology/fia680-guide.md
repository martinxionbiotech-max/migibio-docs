...
date: 2026-08-13
description: "Complete operation guide for the Migibio FIA680 single-channel fluorescence immunoassay analyzer — workflow, sample types, calibration, maintenance, and troubleshooting."
---
...
| Standard-curve update | Via QR code (per assay lot) |
...
|---------|--------------|--------|
| No result | Cartridge not seated | Re-insert cartridge |
| Error code | Insufficient sample volume | Repeat with fresh cartridge |
| Drifting results | Dirty optical path | Clean optical path |
