...
date: 2026-08-13
description: "Complete operation guide for the Migibio FIA880 six-channel fluorescence immunoassay analyzer — high-throughput workflow, mixed assays, cloud calibration, and maintenance."
---
...
The six channels run **different assays simultaneously** — for example, a dyspnea workup can run NT-proBNP, CRP, and a chemistry marker in a single run, cutting total turnaround time.

## Operation Workflow

1. **Prepare cartridges** for each assay (up to six).
2. **Apply samples** to each cartridge.
...
| Cloud curve sync | Automatic (per assay lot) |
