---
title: "ISO9001, GMP & Documentation: The Compliance Framework"
date: 2026-08-13
description: "The ISO9001/GMP quality framework behind Migibio products — IFU, COA, documentation requirements, and what they mean for the end user."
---
...
```
GMP production → Lot validation → COA → IFU → Correct use
```
